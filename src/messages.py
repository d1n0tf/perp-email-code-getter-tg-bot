...
MESSAGES = {
    "ru": {
        ...
        "start_text": (
            "Отправь email в формате `example@outlook.com`, и я попробую получить код с этой почты."
        ),
        "help_text": (
            "Что умеет бот:\n"
            "- `/start` — выбрать язык\n"
    ...
    "en": {
        ...
        "start_text": (
            "Send an email in the `example@outlook.com` format and I will try to fetch "
            "the code for it.\n"
        ),
        "help_text": (
            "What the bot can do:\n"
